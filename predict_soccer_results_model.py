...
print(mean_absolute_error(y_home_test, tpred_home_lm),
      mean_absolute_error(y_home_test, tpred_home_lml),
      mean_absolute_error(y_home_test, tpred_home_rf),
      mean_absolute_error(y_home_test, (tpred_home_lml + tpred_home_rf)/2))
...
print(mean_absolute_error(y_away_test, tpred_away_lm),
      mean_absolute_error(y_away_test, tpred_away_lml),
      mean_absolute_error(y_away_test, tpred_away_rf),
      mean_absolute_error(y_away_test, (tpred_away_lml + tpred_away_rf)/2))
